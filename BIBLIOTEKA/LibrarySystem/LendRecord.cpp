...
namespace LibrarySystem
{
	...
	LendRecord::LendRecord(LibraryItem * itemToLend, User* lendingUser)
	{
	...
	void LendRecord::BindUser(User * user)
	{
		m_user = user;
	}

	void LendRecord::BindItem(LibraryItem* item)
	{
		m_lendedItem = item;
	}
	...
	LibrarySystem::LibraryItem* LendRecord::ReturnItem(double money)
	{
